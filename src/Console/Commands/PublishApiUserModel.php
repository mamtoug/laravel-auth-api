...
namespace Mamtoug\LaravelAuthApi\Console\Commands;
...
class PublishApiUserModel extends GeneratorCommand
{
    ...
    {
        \Artisan::call('vendor:publish', ['--provider' => 'Mamtoug\LaravelAuthApi\LaravelAuthApiServiceProvider', '--tag' => 'config']);
    ...
    /**
     * Build the class. Replace Mamtoug namespace with App one.
     *
     * @param  string  $name
     * @return string
     */
    ...
    {
        $stub = str_replace('Mamtoug\LaravelAuthApi\Models;', $this->laravel->getNamespace().'Models;', $stub);
