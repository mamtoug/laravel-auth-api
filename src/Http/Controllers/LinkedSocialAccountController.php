...
class LinkedSocialAccountController extends Controller
{
    public function findOrCreate(SocialAccountRequest $request)
    {
        ...
        if ($socialAccount) {
            ...
            ], 1, 200, trans('translation.linked_social.find_associated', ['provider_name' => $request->provider_name]));
        }
        ...
        if ($newUser) {
            ...
            ], 1, 201, trans('translation.linked_social.user_created'));
        }
        ...
        return ApiResponse::send([
            ...
            'user' => $user,
            'access_token' => $user->createToken('AppName')->accessToken,
        ], 1, 201, trans('translation.linked_social.social_account_created_for_user', ['name' => $request->name]));
    }
